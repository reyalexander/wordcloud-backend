    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=32, verbose_name='nombres')),
                ('last_name', models.CharField(max_length=32, verbose_name='apellidos')),
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'Activo'), (2, 'Inactivo'), (3, 'Eliminado')], default=1)),
